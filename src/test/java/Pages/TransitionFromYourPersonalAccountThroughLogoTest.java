...
public class TransitionFromYourPersonalAccountThroughLogoTest {
    ...
    public TransitionFromYourPersonalAccountThroughLogoTest(String browserType) {
    ...
    public void transitionFromYourPersonalAccountToTheDesigner() {
        ...
        Allure.step("Переходим в Конструктор через логотип", () ->
                clickIfVisibleAndClickable(Locators.LOGO_BUTTON));
