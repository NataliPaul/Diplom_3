...
public class UserLoginInTheRegistrationFormTest {
    ...
    public UserLoginInTheRegistrationFormTest(String email, String password, boolean isValid, String browserType) {
        this.email = email;
    ...
    @Parameterized.Parameters(name = "{index}: авторизация с : EMAIL={0}, PASSWORD={1}, BROWSER={3}")
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
                {Constants.EMAIL, Constants.PASSWORD, true, "chrome"},
                {Constants.EMAIL, Constants.PASSWORD, true, "yandex"},
    ...
    public void loginUser(By loginButtonLocator) {
        ...
        mainPage.clickButton(loginButtonLocator);
        // Нажимаем кнопку Зарегистрироваться
        mainPage.clickButton(Locators.REGISTER_BUTTON_BEFORE_INPUT);
        // Нажимаем кнопку Войти
        mainPage.clickButton(Locators.LOGIN_BUTTON_REGISTER);
