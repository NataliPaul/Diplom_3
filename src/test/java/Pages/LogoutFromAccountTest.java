...
public class LogoutFromAccountTest {
    ...
    private final String browserType;
     ...
     public LogoutFromAccountTest(String browserType) {
    ...
    public void goToYourPersonalAccount() {
        ...
        Allure.step("Переходим в Личный кабинет", () ->
                clickIfVisibleAndClickable(Locators.PERSONAL_ACCOUNT_BUTTON));
        mainPage.clickButton(Locators.ENTRY_BUTTON);
        Allure.step("Проверяем наличие текста 'Вход'", () ->
                checkElementVisibilityAndContent(Locators.AVAILABILITY_OF_HEADER_INPUT, Constants.TEXT_AVAILABILITY_OF_HEADER_INPUT));
